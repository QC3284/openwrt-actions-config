...
#最后更新时间：2024.11.29
7zz a -mx=9 -mmt=8 "openwrt-23.05.5-ramips-mt7621-xiaomi_mi-router-cr6606.7z" "openwrt-23.05.5-ramips-mt7621-xiaomi_mi-router-cr6606-initramfs-kernel.bin" "openwrt-23.05.5-ramips-mt7621-xiaomi_mi-router-cr6606-squashfs-firmware.bin" "openwrt-23.05.5-ramips-mt7621-xiaomi_mi-router-cr6606-squashfs-sysupgrade.bin"
sleep 3
...
sleep 3
7zz a -mx=9 -mmt=8 "immortalwrt-23.05.4-ramips-mt7621-xiaomi_mi-router-cr6606.7z" "immortalwrt-23.05.4-ramips-mt7621-xiaomi_mi-router-cr6606-initramfs-kernel.bin" "immortalwrt-23.05.4-ramips-mt7621-xiaomi_mi-router-cr6606-squashfs-firmware.bin" "immortalwrt-23.05.4-ramips-mt7621-xiaomi_mi-router-cr6606-squashfs-sysupgrade.bin"
7zz a -mx=9 -mmt=8 "cr660x-pb-boot.7z" "pb-boot.ecc" "pb-boot.img" "pb-boot.sha256"
sleep 3
